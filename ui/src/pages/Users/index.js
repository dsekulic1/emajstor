...
import { getAuthConfig } from 'api/common'
...
export default function Users() {
  ...
  // const [korisnik, setUser] = useState({firstName:"", lastName:"", email:"",number:"",username:"", password:"", city:""})
  ...
  const handleSubmit = (event) => {
    event.preventDefault()
      ...
      const values = [{op:"/replace",path:"/role", value:permission}]

    onFinish(values,temprow?.id)
  }
          ...
          <TableBody>
            {rows.map((row) => (
              <TableRow key={row.id}>
                ...
                <TableCell align='right'><SettingsAccessibilityIcon onClick={()=>handleOpen(row)}></SettingsAccessibilityIcon>
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
