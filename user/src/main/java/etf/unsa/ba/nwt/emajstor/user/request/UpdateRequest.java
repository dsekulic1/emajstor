...
public class UpdateRequest {
    ...
    public UpdateRequest(String firstName, String lastName, String email, String number, String username, String city, double locationLongitude, double locationLatitude) {
